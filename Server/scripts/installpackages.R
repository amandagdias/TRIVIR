  ...
  if (!suppressMessages(require("stringi"))) suppressMessages(install.packages("stringi", repos = "http://cran.us.r-project.org"));
  ...
  if (!suppressMessages(require("chron"))) suppressMessages(install.packages("chron", repos = "http://cran.us.r-project.org"));
